...
- **Charge realistic trading frictions** (standard practice) — matched: “vary the random-feature seed and report the spread across draws”
...
- Matching is keyword; a correct test described in unanticipated words scores as a miss.
