...
|---|---|---|
| Buy the Dip internship study | Repository descriptions say real option chains and fundamentals were used. No employer/client release approval is recorded. | Keep gated until the owner checks internship agreements, vendor terms, identifiers and every committed derived table. |
| Vol Harvest internship study | The repository contains recorded model grids and real-chain results, but no public-release approval. | Keep gated until the same owner review is recorded. |
| Distribution Shift internship study | Saved deployed-feature, prediction and rolling-metric series expose behavior from a deployed study. No public-release approval is recorded. | Treat as the highest confidentiality risk; keep gated until explicit authorization and de-identification review are recorded. |
