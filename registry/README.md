...
| volatility-managed-realtime | a real-time investor gains economically by adding a volatility-managed portfolio to the original market and cash | Cederburg, O'Doherty, Wang and Yan (2020), 'On the Performance of Volatility-Managed Portfolios', Journal of Financial Economics | verdict-delivered | NO CLEAR REAL-TIME IMPROVEMENT |
